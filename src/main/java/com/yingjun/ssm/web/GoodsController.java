...
public class GoodsController {
	 ...
	 * String list(Model entity, Integer offset, Integer limit) {
	 * logger.info("invoke----------/goods/list"); offset = offset == null ? 0 :
	 * offset;//默认便宜0 limit = limit == null ? 50 : limit;//默认展示50条 List<Goods>
	 * list = goodsService.getGoodsList(offset, limit);
	 * entity.addAttribute("goodslist", list); return "goodslist"; }
	 */
